...
public class Constant {
    ...
    public static final String room_id = "room_id_1";     // 你部署的业务后台用到的参数
    public static final String agent_name = "AI Agent Example 1";  // 你部署的业务后台用到的参数
    public static final String agent_stream_id = "agent_stream_id_1";  // 你部署的业务后台用到的参数
    public static final String agent_zim_uid = "agent_user_id_1";  // 你部署的业务后台用到的参数
